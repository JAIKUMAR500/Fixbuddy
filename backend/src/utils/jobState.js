...
export const ALLOWED_TRANSITIONS = {
  ...
  accepted: ["on_the_way", "scheduled", "arrived", "cancelled", "open", "matching"],
  scheduled: ["on_the_way", "accepted", "arrived", "cancelled", "matching"],
  on_the_way: ["arrived", "cancelled", "open", "matching"],
  arrived: ["otp_verified", "in_progress", "cancelled", "matching"],
  otp_verified: ["in_progress", "cancelled", "matching"],
  in_progress: ["completed", "cancelled", "matching"],
