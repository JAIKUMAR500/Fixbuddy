  ...
  return (
    <section className="space-y-4">
      ...
      <Card padding="md" className="border-sky-200 bg-sky-50">
        ...
        <div className="mt-4 h-3 rounded-full bg-white overflow-hidden"><div className="h-full rounded-full bg-sky-600" style={{ width: `${target?.progress || 0}%` }} /></div>
